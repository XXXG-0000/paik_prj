<%@ page contentType="text/html;charset=UTF-8" language="java" info="EL에서 vo를 사용하는 방법" trimDirectiveWhitespaces="true" %>
...
<head>
    ...
    <link rel="stylesheet" href="../manager/common/css/main_20240911.css">
