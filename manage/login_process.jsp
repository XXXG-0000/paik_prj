<%@ page import="paik_prj.paik_prj.manager.paik.manager.ManagerDAO" %>
...
<jsp:useBean id="mVO" class="paik_prj.paik_prj.manager.paik.manager.ManagerVO" scope="page"/>
...
<jsp:useBean id="managerVO" class="paik_prj.paik_prj.manager.paik.manager.ManagerVO" scope="page"/>
...
<head>
    ...
    var url="http://paiks.sist.co.kr/manage/dashboard/dashboard.jsp";
