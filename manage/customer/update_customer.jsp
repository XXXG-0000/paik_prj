...
<jsp:useBean id="cVO" scope="page" class="paik_prj.paik_prj.manager.paik.customer.CustomerVO"/>
...
%>
    ...
    <script type="text/javascript">
        ...
        alert(msg);
        location.href="http://paiks.sist.co.kr/manage/customer/list_customer.jsp";
        $(function () {
