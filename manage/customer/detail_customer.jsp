...
<%@ page import="paik_prj.paik_prj.manager.paik.customer.CustomerDAO" %>
<%@ page import="java.sql.SQLException" %>
<%@ page import="paik_prj.paik_prj.manager.paik.customer.Grade"%>
<%@ page import="paik_prj.paik_prj.manager.paik.customer.CustomerVO" %>
...
<head><script src="/docs/5.3/assets/js/color-modes.js"></script>
    ...
    function movePage(flag) {
        ...
        if(pass_flag===true && name_flag){
          if(flag ==='u'){
               document.customerFrm.action="http://paiks.sist.co.kr/manage/customer/update_customer.jsp";
               $("#customerFrm").submit();
               return;
           }
          if(flag ==='d'){
             ...
             if(confirm(`[ ${cVO.cusId} ] 유저를 정말 `+actionText+ `으로 변경하시겠습니까?`)){
                document.customerFrm.action="http://paiks.sist.co.kr/manage/customer/delete_customer.jsp?cusId=<%=cusId%>";
                $("#customerFrm").submit();
            }
             return;
         }
          location.href="http://paiks.sist.co.kr/manage/customer/list_customer.jsp?currentPage=${param.currentPage}";
        }
    }
            ...
            <div class="offcanvas-md offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu" aria-labelledby="sidebarMenuLabel">
                <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
                    <ul class="nav nav-pills flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link d-flex align-items-center gap-2" href="http://paiks.sist.co.kr/manage/menu/selectDessertList.jsp">
                        ...
                        <li class="nav-item">
                            <a class="nav-link d-flex align-items-center gap-2 active" href="http://paiks.sist.co.kr/manage/customer/list_customer.jsp">
                    ...
                    <ul class="nav flex-column mb-auto">
                        <li class="nav-item">
                            <a class="nav-link d-flex align-items-center gap-2" href="http://paiks.sist.co.kr/manage/logout.jsp">
