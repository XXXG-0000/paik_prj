...
<%@ page import="paik_prj.paik_prj.manager.paik.customer.CustomerUtil" %>
    ...
    <div class="row">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                ...
                <jsp:useBean id="sVO" scope="page" class="paik_prj.paik_prj.manager.paik.customer.SearchVO"/>
                ...
                <table>
                    ...
                    <c:if test="${empty listCustomer}">
                        <td style="text-align: center" colspan="7">
                            ...
                            <a href="http://paiks.sist.co.kr/manage/dashboard/dashboard.jsp">돌아가기</a>
                        </td>
                    </c:if>
