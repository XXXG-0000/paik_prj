...
<%@page import="paik_prj.paik_prj.manager.paik.util.OrderUtil"%>
<%@page import="paik_prj.paik_prj.manager.paik.order.OrderVO"%>
<%@page import="java.util.List"%>
<%@page import="java.sql.SQLException"%>
<%@page import="paik_prj.paik_prj.manager.paik.order.OrderDAO"%>
						...
						success:function(jsonObj){
							if(jsonObj.result){//post 방식으로 잘 실행되었을 경우
								if(jsonObj.update){//양 변경에 성공했을 경우
									alert("상태를 변경했습니다.");
									var url = "http://paiks.sist.co.kr/manage/order/selectNotReceivedOrderList.jsp";
...
<div class="container-fluid">
    <div class="row">
            ...
            <div class="offcanvas-md offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu" aria-labelledby="sidebarMenuLabel">
                ...
                <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
                    <ul class="nav nav-pills flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link d-flex align-items-center gap-2 active" href="http://paiks.sist.co.kr/manage/order/selectNotReceivedOrderList.jsp">
        ...
        <jsp:useBean id="sVO" class="paik_prj.paik_prj.manager.paik.order.SearchVO" scope="page"/>
