    ...
    <div class="row">
		...
		<form action="insertDrinkProcess.jsp" name="insertFrm" id="insertFrm" method="post" accept-charset="UTF-8">
		    ...
		    <table id="ingredientTable">
		        ...
		        <tr>
		            <td>카페인</td>
		            <td><input type="text" id="caffeine" name="caffeine"></td>
		        </tr>
		        <tr>
		            <td>칼로리</td>
		        ...
		        <tr>
		            <td>나트륨</td>
		            <td><input type="text" id="natrium" name="natrium"></td>
		        </tr>
		        <tr>
		            <td>당류</td>
		        ...
		        <tr>
		            <td>포화지방</td>
		            <td><input type="text" id="fattyAcid" name="fattyAcid"></td>
		        </tr>
		        <tr>
		            <td>단백질</td>
