...
<jsp:useBean id="pVO" class="paik_prj.paik_prj.manager.paik.menu.ProductVO" scope="page"/>
<jsp:useBean id="iVO" class="paik_prj.paik_prj.manager.paik.menu.IngredientVO" scope="page"/>
<jsp:useBean id="oVO" class="paik_prj.paik_prj.manager.paik.menu.DrinkOptionVO" scope="page"/>
...
<script src="/docs/5.3/assets/js/color-modes.js"></script>
    ...
    <title>음료 추가</title>
	<link rel="stylesheet" type="text/css" href="http://paiks.sist.co.kr/manage/common/css/main_20240911.css">
