<%@page import="paik_prj.paik_prj.manager.paik.menu.DessertIceDAO"%>
<%@page import="paik_prj.paik_prj.manager.paik.menu.IngredientVO"%>
<%@page import="paik_prj.paik_prj.manager.paik.menu.IcecreamOptionVO"%>
<%@page import="java.sql.SQLException"%>
<%@page import="paik_prj.paik_prj.manager.paik.menu.ProductVO"%>
<%@page import="paik_prj.paik_prj.manager.paik.menu.SearchVO"%>
...
<script src="/docs/5.3/assets/js/color-modes.js"></script>
    ...
    <link rel="stylesheet" href="http://paiks.sist.co.kr/manage/common/css/orderStateList.css">
    <link rel="stylesheet" href="http://paiks.sist.co.kr/manage/common/css/orderDetails.css">
...
<script src="https://cdn.jsdelivr.net/npm/sweetalert2@11.4.10/dist/sweetalert2.min.js"></script>  
    ...
    $(function(){
     	$("#confirm").click(function(){
			var url="http://paiks.sist.co.kr/manage/menu/selectIcecreamList.jsp?currentPage=${ param.currentPage }"
...
<div class="container-fluid">
    <div class="row">
            ...
            <div class="offcanvas-md offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu" aria-labelledby="sidebarMenuLabel">
                ...
                <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
                    <ul class="nav nav-pills flex-column">
                        <li class="nav-item">
                            <a class="nav-link d-flex align-items-center gap-2" aria-current="page" href="http://paiks.sist.co.kr/manage/dashboard/dashboard.jsp">
                                <i class="bi bi-house"></i>
                                관리자 대시보드
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link d-flex align-items-center gap-2" href="http://paiks.sist.co.kr/manage/menu/selectCoffeeList.jsp">
                                <svg class="bi"><use xlink:href="#cup-hot"/></svg>
                                음료 관리
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link d-flex align-items-center gap-2 active" href="http://paiks.sist.co.kr/manage/menu/selectDessertList.jsp">
                            	<svg class="bi"><use xlink:href="#cake"/></svg>
                                디저트&아이스크림 관리
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link d-flex align-items-center gap-2" href="http://paiks.sist.co.kr/manage/order/selectNotReceivedOrderList.jsp">
                        ...
                        <!-- <li class="nav-item">
                            <a class="nav-link d-flex align-items-center gap-2" href="http://paiks.sist.co.kr/manage/voc/getListCustomSound.jsp">
        ...
        <form action="selectIcecreamList.jsp" name="readFrm" id="readFrm" method="post">
			...
			<fieldset>
			    <legend>카테고리</legend>
			    <label>아이스크림<input type="radio" name="categoriesNum" value="3" <c:if test="${ pVO.categoriesNum eq 3 }">checked="checked"</c:if> /></label>
			</fieldset>
