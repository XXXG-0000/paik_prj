...
<%@page import="paik_prj.paik_prj.manager.paik.menu.DrinkOptionVO"%>
...
<script src="https://cdn.jsdelivr.net/npm/sweetalert2@11.4.10/dist/sweetalert2.min.js"></script>  
    ...
    $(function(){
     	$("#confirm").click(function(){
			var url="http://paiks.sist.co.kr/manage/menu/selectCoffeeList.jsp?currentPage=${ param.currentPage }"
            ...
            <div class="offcanvas-md offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu" aria-labelledby="sidebarMenuLabel">
                ...
                <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
                    <ul class="nav nav-pills flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link d-flex align-items-center gap-2 active" href="http://paiks.sist.co.kr/manage/menu/selectCoffeeList.jsp">
