...
<%@page import="paik_prj.paik_prj.manager.paik.menu.DrinkDAO"%>
...
<script src="https://cdn.jsdelivr.net/npm/sweetalert2@11.4.10/dist/sweetalert2.min.js"></script>  
    ...
    $(function(){
     	$("#confirm").click(function(){
			var url="http://paiks.sist.co.kr/manage/menu/selectDessertList.jsp?currentPage=${ param.currentPage }"
...
<div class="container-fluid">
    <div class="row">
        ...
        <form action="selectDessertList.jsp" name="readFrm" id="readFrm" method="post">
			...
			<fieldset>
			    <legend>카테고리</legend>
			    <label>디저트<input type="radio" name="categoriesNum" value="2" <c:if test="${ pVO.categoriesNum eq 2 }">checked="checked"</c:if> /></label>
			</fieldset>
