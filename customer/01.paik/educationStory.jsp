...
<p><%-- 서브타이틀 --%></p>
	...
	<ul class="page_tab st-2">
		<li><a href="http://paiks.sist.co.kr/customer/01.paik/introduction.jsp">빽스커피 소개</a></li>
		<li><a href="http://paiks.sist.co.kr/customer/01.paik/coffeeStory.jsp">커피 이야기</a></li>
		<li class="on"><a href="http://paiks.sist.co.kr/customer/01.paik/educationStory.jsp">교육 이야기</a></li>
	</ul>
	</div>
<p><%-- //서브타이틀 --%></p>
...
<div class="edu_story">
	<div class="barista_con">
		...
		<ul>
			<li>
				<div class="bari_img"><img src="http://paiks.sist.co.kr/customer/01.paik/images/barista_img01.jpg" alt="바리스타 2급" /></div>
				<div class="bari_txt">
					<span>바리스타 2급</span>
			...
			<li>
				<div class="bari_img"><img src="http://paiks.sist.co.kr/customer/01.paik/images/barista_img02.jpg" alt="바리스타 1급" /></div>
				<div class="bari_txt">
					<span>바리스타 1급</span>
	...
	<div class="qualifying_con">
		<div class="con_align">
			...
			<div class="goal_con">
				...
				<ul>
					<li>
						<div class="goal_img"><img src="http://paiks.sist.co.kr/customer/01.paik/images/goal_img01.jpg" alt="브랜드 일관성" /></div>
						<dl>
							<dt>브랜드 일관성</dt>
					...
					<li>
						<div class="goal_img"><img src="http://paiks.sist.co.kr/customer/01.paik/images/goal_img02.jpg" alt="고객 신뢰" /></div>
						<dl>
							<dt>고객 신뢰</dt>
					...
					<li>
						<div class="goal_img"><img src="http://paiks.sist.co.kr/customer/01.paik/images/goal_img03.jpg" alt="직원 성장" /></div>
						<dl>
							<dt>직원 성장</dt>
