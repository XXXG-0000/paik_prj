	...
	<div class="txt">
		...
		<div class="tabMenu">
			<ul class="pageTab">
				...
				<li class="on"><a href="http://paiks.sist.co.kr/customer/02.menu/coffeeMenuPage.jsp">커피</a></li>
				<li><a href="http://paiks.sist.co.kr/customer/02.menu/drinkMenuPage.jsp">음료</a></li>
