...
%>
<jsp:useBean id="ciVO" class="paik_prj.paik_prj.customer.paik.CartItemVO" scope="session"/>
<jsp:setProperty name="ciVO" property="*"/>
<jsp:useBean id="iVO" class="paik_prj.paik_prj.customer.paik.ItemVO" scope="session"/>
