...
<%@page import="paik_prj.paik_prj.customer.paik.ItemDAO"%>
<%@page import="paik_prj.paik_prj.customer.paik.ItemVO"%>
...
%>
<script src="http://paiks.sist.co.kr/customer/02.menu/jsp/menu.js"></script>
...
<div class="sub_visual bg-menu3">
	<div class="txt">
		...
		<div class="tabMenu">
			<ul class="pageTab">
				<li><a href="http://paiks.sist.co.kr/customer/02.menu/newMenuPage.jsp">신메뉴</a></li>
				<li><a href="http://paiks.sist.co.kr/customer/02.menu/coffeeMenuPage.jsp">커피</a></li>
				<li class="on"><a href="http://paiks.sist.co.kr/customer/02.menu/drinkMenuPage.jsp">음료</a></li>
				<li><a href="http://paiks.sist.co.kr/customer/02.menu/icecreamDessertMenuPage.jsp">아이스크림/디저트</a></li>
			</ul>
		</div>
	</div>
</div>
