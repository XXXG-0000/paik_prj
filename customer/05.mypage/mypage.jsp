...
<%@page import="paik_prj.paik_prj.customer.paik.CustomDAO" %>
<%@ page language="java" contentType="text/html; charset=UTF-8"
         pageEncoding="UTF-8"
         info="마이페이지 화면"  trimDirectiveWhitespaces="true" %>
<%
...
<jsp:useBean id="cVO" class="paik_prj.paik_prj.customer.paik.CustomVO" scope="request"/>
...
<%
    ...
    if(cusId!=null){
        ...
        pageContext.setAttribute("phone1", phone1);
...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon"
          href="http://paiks.sist.co.kr/customer/00.common/images/favicon.png">
    <title>빽스커피 | 마이페이지</title>


    <link rel="stylesheet" type="text/css" href="http://paiks.sist.co.kr/customer/05.mypage/css/paik_mypage.css">
    ...
    <link rel="apple-touch-icon-precomposed"
          href="http://paiks.sist.co.kr/customer/00.common/images/favicon180x180.png"/>
    <meta name="msapplication-TileImage"
          content="http://paiks.sist.co.kr/customer/00.common/images/favicon270x270.png"/>
    ...
    <script type="text/javascript">
        $(function () {
            $("#btnSubmit").click(function () {
                location.href = "http://paiks.sist.co.kr/customer/05.mypage/modify.jsp";
            });

            $("#changePass").click(function () {
                location.href = "http://paiks.sist.co.kr/customer/05.mypage/chkPass.jsp";
            });
                ...
                <form action="mypage_update_process.jsp" id="updateForm" method="post" style="margin-top: 50px;">
                    ...
                    <div class="status">
                        ...
                        <div class="inputContainer inputPhoneContainer">
                            <input type="text" id="phone1" name="phone1" class="inputPhoneBox" value="${ phone1 }"
                                   style="height: 48px;" maxlength="3" readonly/>
