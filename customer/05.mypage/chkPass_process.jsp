...
<jsp:useBean id="cVO" class="paik_prj.paik_prj.customer.paik.CustomVO" scope="page"/>
...
<link rel="shortcut icon" type="image/x-icon" href="http://paiks.sist.co.kr/customer/00.common/images/favicon.png">
...
<link rel="stylesheet" type="text/css" href="http://paiks.sist.co.kr/customer/05.mypage/css/paik_chgPass.css">
...
if(!flag){
	...
	location.href="http://paiks.sist.co.kr/index.jsp";
}
</script>
</head>
<body>
