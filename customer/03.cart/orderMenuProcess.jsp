...
<jsp:useBean id="ciaVO" class="paik_prj.paik_prj.customer.paik.CartItemArrVO" scope="page"/>
...
if(cnt == 1){
	msg = "주문이 완료되었습니다."
	alert(msg);
	location.href="http://paiks.sist.co.kr/customer/03.cart/list_order.jsp";
} else if(cnt == 0){
