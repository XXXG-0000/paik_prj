<%@ page import="paik_prj.paik_prj.customer.paik.OrderDAO" %>
<%@ page import="paik_prj.paik_prj.customer.paik.ItemDAO" %>
<%@ page import="java.sql.SQLException" %>
<%@ page import="paik_prj.paik_prj.customer.paik.OrderVO" %>
...
<meta name="viewport" content="width=device-width, initial-scale=1.0">
	...
	<link rel="stylesheet" type="text/css"
		  href="http://paiks.sist.co.kr/customer/00.common/css/paik_kl.css">
	<link rel="stylesheet" type="text/css"
		  href="http://paiks.sist.co.kr/customer/00.common/css/paik_extend.css">
	<link rel="stylesheet" type="text/css"
		  href="http://paiks.sist.co.kr/customer/00.common/css/paik_normal.css">
	<link rel='stylesheet'
	...
	<div class="list_container">
		...
		<c:if test="${empty orderList}">
			<div class="order-item empty-order" style="text-align: center; font-size: 20px; padding: 50px 0;">
				...
				<div class="order-button">
					<a href="http://paiks.sist.co.kr/customer/02.menu/newMenuPage.jsp" class="btn btn-order" style="padding: 15px 30px; background-color: #f8a541; color: #fff; font-size: 18px; border-radius: 25px; text-decoration: none; transition: all 0.3s ease;">
						따끈 따끈한 신메뉴 보러가기
					</a>
				</div>
			</div>
		...
		<c:forEach var="oVO" items="${orderList}" varStatus="i">
			<div class="order-item">
				<div class="order-date" style="font-size: 18px;"> 주문일 <fmt:formatDate value="${oVO.inputDate}" pattern="yyyy-MM-dd HH:mm"/></div>
