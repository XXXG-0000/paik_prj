...
<%@page import="paik_prj.paik_prj.customer.paik.CartItemDAO"%>
<%@page import="java.util.List"%>
<%@ page import="paik_prj.paik_prj.customer.paik.CartItemVO" %>
...
<jsp:useBean id="ciVO" class="paik_prj.paik_prj.customer.paik.CartItemVO" scope="page"/>
<jsp:useBean id="iVO" class="paik_prj.paik_prj.customer.paik.ItemVO" scope="page"/>
<jsp:useBean id="sVO" class="paik_prj.paik_prj.customer.paik.SearchVO" scope="page"/>
...
<link rel="stylesheet" type="text/css" href="http://paiks.sist.co.kr/customer/02.menu/css/paik_menu.css">
...
<link rel="icon" href="http://paiks.sist.co.kr/00.common/images/favicon32x32.png" sizes="32x32" />
<link rel="icon" href="http://paiks.sist.co.kr/00.common/images/favicon192x192.png" sizes="192x192" />
<link rel="apple-touch-icon-precomposed" href="http://paiks.sist.co.kr/00.common/images/favicon180x180.png" />
<meta name="msapplication-TileImage" content="http://paiks.sist.co.kr/00.common/images/favicon270x270.png" />
	...
	/* 체크박스 전체 선택 */
	  ...
	  /* 총 주문 정보 세팅(배송비, 총 가격, 마일리지, 물품 수, 종류) */
		...
		*/
		...
		$(this).parent().parent().parent().parent().find("td:eq(4)").html(total.toLocaleString() + "원");//수량이 변경된 상품의 금액 변경
		$(this).parent().parent().parent().parent().parent().parent().find("span[class='finalPrice_span']").html(finalTotal.toLocaleString());//상품 총 금액 변경
