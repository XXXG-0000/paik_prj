...
<div class="container">
	<div class="in_footer">
		<a class="logo" href=""><img src="http://paiks.sist.co.kr/customer/00.common/images/logo.png" alt="더본로고"></a>
		<a class="logo light" href=""><img src="http://paiks.sist.co.kr/customer/00.common/images/logo-2.png" alt="더본로고"></a>
		<div class="company_info">
			...
			<ul>
				<li>주소: 서울특별시 강남구 테헤란로 132 한독빌딩 8층</li>
