...
<link rel="stylesheet" type="text/css" href="http://paiks.sist.co.kr/customer/06.customer/find/css/paik_find.css">
...
$(function(){
	$("#okBtn").click(function() {
		$.ajax({
			...
			method: 'POST',
			success: function() {
				window.location.replace("http://paiks.sist.co.kr/customer/06.customer/loginPage.jsp");
			}
		});//ajax
	});
});//ready()
