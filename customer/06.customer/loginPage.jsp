    ...
    <div class="container" style="max-width: 600px; margin: 0 auto; text-align: center;">
        ...
        <form action="login_process.jsp" id="loginFrm" method="post">
            ...
            <table>
                ...
                <tr>
                	<td><a href="http://paiks.sist.co.kr/customer/06.customer/find/findIdPage.jsp">아이디찾기</a> <span class="txt">|</span> 
                		<a href="http://paiks.sist.co.kr/customer/06.customer/find/findPassPage.jsp">비밀번호 찾기</a></td>
                </tr>
            </table>
            </div>
